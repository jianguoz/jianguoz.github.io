...
/* date last modified: 2017-01-25 12:13:05 */
...
function embed_clustrmaps(script_el, embed_after_script){
    ...
    if($('#clustrmaps-widget-v2').length === 0){
        ...
        */
        ...
        var container = $('<a target="_top" href="https://clustrmaps.com/?utm_source=widget&utm_medium=js_widget&utm_campaign=widget_ctr" id="clustrmaps-widget-v2">'
